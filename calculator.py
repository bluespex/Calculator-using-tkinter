...
class Calculator:
	def __init__(self,master):
		self.master = master
		master.title("Python Claculator")
		...
		b17 = self.createButton('=',None,17)
		b18 = self.createButton('Clear',None,17)
		...
		for row in range(1,5):
			for column in range(4):
				...
				count+=1
		buttons[16].grid(row=5,column=0,columnspan=2)
		buttons[17].grid(row=5,column=2,columnspan=2)
